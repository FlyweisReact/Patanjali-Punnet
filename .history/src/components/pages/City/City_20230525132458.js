...
import { Button, Modal, Form, Container, Table, Alert, Spinner } from "react-bootstrap";
...
const City = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const EditProduct = async (e) => {
      ...
      try {
        const { data } = await axios.post(
         `https://puneet-goyal-backend.vercel.app/api/v1/admin/product/646f07febf06d9f0b4667499` ,
          { name, description, price, category, images: url, Stock },
          Auth
        );
        console.log(data);
